...
#define plugInName "Adaptive Wiener Filter"
#ifdef NDEBUG
...
#define plugInEventID eventFilterAW
   ...
   1, 0, english, roman,                  /* aete version and language specifiers */
   {
      ...
      {  /* structure for filters */
         ...
         {  /* parameters here, if any */
            ...
            keyNoise,                     /* parameter key ID */
            typeFloat,                    /* parameter type ID */
            "noise estimate",             /* optional description */
            flagsSingleParameter,         /* parameter flags */

            "auto",                       /* parameter name */
            keyAuto,                      /* parameter key ID */
            typeBoolean,                  /* parameter type ID */
            "automatic noise threshold",  /* optional description */
            flagsSingleParameter,         /* parameter flags */
