...
/*
  ...
  on-screen); added boolean to choose whether the result should be appended to
  the file; added booleans to determine what should be computed.
*/
...
/*
  ...
  revamped user interface: we now allow the user to select between displaying
  results on-screen or appending to a file; added scripting support.
