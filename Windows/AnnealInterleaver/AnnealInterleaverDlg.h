...
#if !defined(                                                                  \
    AFX_ANNEALINTERLEAVERDLG_H__B8D362B1_70F2_4117_B04D_3885D130024F__INCLUDED_)
...
class CAnnealInterleaverDlg : public CDialog,
                              private libcomm::annealer,
                              libwin::CWorkerThread
{
    // Construction
public:
    void ResetDisplay();
