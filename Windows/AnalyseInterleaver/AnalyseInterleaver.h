...
// AnalyseInterleaver.h : main header file for the ANALYSEINTERLEAVER
// application
//

#if !defined(                                                                  \
    AFX_ANALYSEINTERLEAVER_H__89E75CC4_1552_4D3F_8893_EB326FAB5603__INCLUDED_)
...
/*
  ...
  modified redirection of cerr/clog/cout to used read-buffer manipulation
  instead of direct assignment. This was necessitated in VS .NET 2005, but the
  code was not written to be compiler-dependent in the hope that this should
  still work on older Visual compilers.
