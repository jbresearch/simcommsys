...
1.0
    ...
    // const double VN = 0.0004302606584964948; //1.041915; // Variance VN, the
    // new CLI parameter.
    // If VA = 18.5, SNR_linear ~ 17.7558
    ...
    // SNR_linear = 1.335929371, SNR_dB = 1.25783498,  elevation angle
    = 40.34405295 degrees
    // const double VN = 1.61685;
    */
    // SNR_linear = 3.104172843 , SNR_dB = 4.919458951,  elevation angle
    // = 89.66604521 degrees
...
BOOST_AUTO_TEST_CASE(test_cvqkd_fullcyclecvqkdresults_single_vn,
...
sign<double>
    ...
    */
    ...
    // const double VN = 0.0004302606584964948; //1.041915; // Variance VN, the
    // new CLI parameter. If VA = 18.5, SNR_linear ~ 17.7558
...
1.0
    ...
    auto [MI_Check,
          ...
          VN_hat,
          alpha_hat,
          len_secret_key] = sys->fullcyclecvqkdresults(source);

    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Variance VN: " << VN_result
              << std::endl; // VN already existed as a variable so I had to
                            // rename this
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Variance VN_hat: " << VN_hat
              << std::endl;
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Variance VA_hat: " << VA_hat
              << std::endl;
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Variance alpha_hat: " << alpha_hat
              << std::endl;
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Mutual Information Check: "
              << MI_Check << std::endl;
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Mutual Information I_AB: " << I_AB
              << std::endl;
    std::cout << "TESTGAUSSIANCVQKD_RESULTS:  Holevo Bound: " << chi_BE
              << std::endl;
...
split_csv_line(const std::string& line, char delimiter)
{
                     ...
                     *boost::unit_test::disabled())
{
    ...
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/fog_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/clear_thin_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/fog_thin_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/clear_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/snow_thin_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/rain_cirrus_alpha_0_34641.csv";
    const std::string input_csv_filename =
        "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/"
        "snow_cirrus_alpha_0_34641.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/rain_thin_cirrus_alpha_0_34641.csv";

    // Output File (Write to Results folder)
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/fog_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/clear_thin_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/fog_thin_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/clear_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/snow_thin_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/rain_cirrus_alpha_0_34641_results.csv";
    const std::string output_csv_filename =
        "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/"
        "snow_cirrus_alpha_0_34641_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/rain_thin_cirrus_alpha_0_34641_results.csv";
...
1.0
    ...
    auto sim = std::make_shared<libcomm::qkd_commsys_simulator<S, T>>(
        std::static_pointer_cast<libbase::random>(rng), s_ptr, sys);
    ...
    std::cout << "Processing " << csv_data.size() - 1 << " rows..."
              << std::endl;
    ...
    for (size_t i = 1; i < csv_data.size(); ++i) {
        try {
            ...
            int framesize = sys->input_block_size();
            // std::cout << "Generating source sequence of size " << framesize
            // << "..." << std::endl;
            libbase::vector<libcomm::gaussian_state> source =
                src->generate_sequence(
                    libbase::size_type<libbase::vector>(framesize));
            ...
            auto [MI_Check,
                  ...
                  VN_hat,
                  alpha_hat,
                  len_key] = sys->fullcyclecvqkdresults(source);
            ...
            std::cout << "Row " << i << ": VN =" << current_vn
                      << " -> alpha_hat =" << alpha_hat << " -> I_AB =" << I_AB
                      << std::endl;

        } catch (const std::exception& e) {
            std::cerr << "Error processing row " << i << ": " << e.what()
                      << std::endl;
        }
    }
    ...
    if (!file_out.is_open()) {
        BOOST_FAIL("Could not open output CSV file for writing: " +
                   output_csv_filename);
    }
    ...
    std::cout << "Batch processing complete. Results saved to "
                     ...
                     *boost::unit_test::disabled())
{
    ...
    // Input File (Read from Test_Data)
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/Test_Data_Signal_Gated/fog_thin_cirrus_rep_rate_200_snr_window_03_ns.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/Test_Data_Signal_Gated/snow_cirrus_rep_rate_200_snr_window_03_ns.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/Test_Data_Signal_Gated/snow_thin_cirrus_rep_rate_200_snr_window_03_ns.csv";
    // const std::string input_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Test_Data/Test_Data_Signal_Gated/clear_rep_rate_200_snr_window_03_ns.csv";
    // const std::string input_csv_filename =
    ...
    // Output File (Write to Results folder)
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/Results_signal_gated/fog_thin_cirrus_rep_rate_200_snr_window_03_ns_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/Results_signal_gated/snow_cirrus_rep_rate_200_snr_window_03_ns_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/Results_signal_gated/snow_thin_cirrus_rep_rate_200_snr_window_03_ns_results.csv";
    // const std::string output_csv_filename =
    // "/home/aaron7/git_projects/simcommsys/Test/TestGaussianCVQKD/Results/Results_signal_gated/clear_rep_rate_200_snr_window_03_ns_results.csv";
    // const std::string output_csv_filename =
