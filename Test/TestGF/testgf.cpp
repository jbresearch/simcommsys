...
void TestFastGF2()
{
    ...
    cout << std::endl
         << "Checking gf_fast<1.0x3> against gf<1,0x3>" << std::endl;
    // init the new gf
...
void TestFastGF4()
{
    ...
    cout << std::endl
         << "Checking gf_fast<2, 0x7> against gf<2, 0x7>" << std::endl;
    ...
    cout << "multiplying all non-zero field elements together 1,000,000 times "
            "in gf<2,0x7>"
         << std::endl;
    t1.start();
    gf1 = gf<2, 0x7>(1);
    ...
    cout << "adding all non-zero field elements together 1,000,000 times in gf"
         << std::endl;
    t1.start();
    gf1 = gf<2, 0x7>(1);
    for (int loop1 = 0; loop1 < 1000000; loop1++) {
    ...
    cout << "adding all non-zero field elements together 1,000,000 times in "
            "gf_fast"
         << std::endl;
    t1.start();
    gffast1 = gf_fast<2, 0x7>(1);
...
void TestFastGF8()
{
    ...
    cout << std::endl
         << "Checking gf_fast<3, 0xB> against gf<3, 0xB>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
...
void TestFastGF16()
{
    ...
    cout << std::endl
         << "Checking gf_fast<4, 0x13> against gf<4, 0x13>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
...
void TestFastGF32()
{
    ...
    cout << std::endl
         << "Checking gf_fast<5, 0x25> against gf<5, 0x25>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
...
void TestFastGF64()
{
    ...
    cout << std::endl
         << "Checking gf_fast<6, 0x43> against gf<6, 0x43>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
...
void TestFastGF128()
{
    ...
    cout << std::endl
         << "Checking gf_fast<7, 0x89> against gf<7, 0x89>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
...
void TestFastGF256()
{
    ...
    cout << std::endl
         << "Checking gf_fast<8, 0x11D> against gf<8, 0x11D>" << std::endl;
    cout << "Checking the powers" << std::endl;
    // check the powers
