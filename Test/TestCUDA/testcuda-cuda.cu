...
public:
    ...
    __host__
#endif
    complex(float r = 0.0, float i = 0.0) : r(r), i(i) {}
    ...
    __host__
#endif
    bool operator==(const complex& x) const { return r == x.r && i == x.i; }
#ifdef __CUDACC__
    __device__
    __host__
#endif
...
void get_sizes(libbase::vector<int>& sizes, libbase::vector<int>& align)
{
    ...
    sizes(i++) = sizeof(fba2<tvb_receiver<bool, float, float>,
                             bool,
                             float,
                             float,
                             false,
                             false,
                             true>::metric_computer);
    sizes(i++) = sizeof(fba2<tvb_receiver<bool, double, float>,
                             bool,
                             double,
                             float,
                             false,
    ...
    align(i++) = __alignof__(fba2<tvb_receiver<bool, float, float>,
                                  bool,
                                  float,
                                  float,
                                  false,
                                  false,
                                  true>::metric_computer);
    align(i++) = __alignof__(fba2<tvb_receiver<bool, double, float>,
                                  bool,
                                  double,
                                  float,
                                  false,
