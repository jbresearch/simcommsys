...
protected:
   ...
   void partial_transform(const libbase::vector<double>& in, libbase::vector<double>& out, const int n) const;
   void partial_inverse(const libbase::vector<double>& in, libbase::vector<double>& out, const int n) const;
...
public:
   ...
   void transform(const libbase::vector<double>& in, libbase::vector<double>& out, const int level=0) const;
   void inverse(const libbase::vector<double>& in, libbase::vector<double>& out, const int level=0) const;

   void transform(const libbase::matrix<double>& in, libbase::matrix<double>& out, const int level=0) const;
   void inverse(const libbase::matrix<double>& in, libbase::matrix<double>& out, const int level=0) const;
};
