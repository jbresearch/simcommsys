...
protected:
   void createmask(libbase::matrix<bool>& mask, const int xsize, const int ysize) const;
public:
   waveletfilter() {};
   waveletfilter(const int nType, const int nPar, const int nLevel, const int nThreshType, const int nThreshSelector, const double dThreshCutoff=0) { init(nType, nPar, nLevel, nThreshType, nThreshSelector, dThreshCutoff); };
   virtual ~waveletfilter() {};
   // initialization
   void init(const int nType, const int nPar, const int nLevel, const int nThreshType, const int nThreshSelector, const double dThreshCutoff=0);
   // progress display
   ...
   void process(const libbase::matrix<double>& in, libbase::matrix<double>& out) const;
};
