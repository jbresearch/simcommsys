...
private:
    ...
    mutable array2vs_t
        encoding_table; //!< Local copy of per-frame encoding table
    std::unique_ptr<typename channel_insdel<sig, real2>::metric_computer>
...
public:
    ...
    {
        this->computer.reset(
            dynamic_cast<typename channel_insdel<sig, real2>::metric_computer*>(
                computer.clone()));
#if DEBUG >= 2
