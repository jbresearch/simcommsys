 ...
 * rows and columns (i.e adjacent symbols in the quadrature and in-phase
 * directions respectively); each symbol then represents the concatenation of
 * these two Gray code values.
 *
