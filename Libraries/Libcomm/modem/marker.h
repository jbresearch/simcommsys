...
private:
    ...
    mutable libbase::randgen
        r; //!< for construction and random application of markers
...
private:
    ...
    // Other utilities
    void
    checkforchanges(int m1_min, int m1_max, int mtau_min, int mtau_max) const;
    // @}
public:
    ...
    int num_symbols() const { return field_utils<sig>::elements(); }
    ...
    double energy() const { return (d + m) / double(d); }
