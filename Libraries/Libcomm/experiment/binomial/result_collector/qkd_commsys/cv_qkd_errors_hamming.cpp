                              ...
                              const libbase::vector<bool>& decoded, int l_secret_key, int framesize) const
{
    ...
    2. Confirm that answer of result(2) is bits/pulse not bits/second. It should be bits per
    pulse as the framesize is the number of generated coherent states for Alice.
    */
    result(2) += l_secret_key/framesize;
}
