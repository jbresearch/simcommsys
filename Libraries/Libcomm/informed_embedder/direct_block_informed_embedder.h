...
#ifndef __direct_block_informed_embedder_h
#define __direct_block_informed_embedder_h
...
/*!
 * \brief   Position-Independent Blockwise Informed Data Embedder/Extractor.
 * \author  Johann Briffa
 *
 * This class is a template definition for position-independent block informed
...
template <class S,
          ...
          class dbl = double>
class direct_block_informed_embedder : public block_informed_embedder<S, C, dbl>
{
};

/*!
 * \brief   Position-Independent Vector Informed Data Embedder/Extractor
 * \author  Johann Briffa
 *
 * Vector implementation of a position-independent block informed embedder.
 */

template <class S, class dbl>
class direct_block_informed_embedder<S, libbase::vector, dbl>
    : public block_informed_embedder<S, libbase::vector, dbl>
{
public:
...
private:
    ...
    std::shared_ptr<informed_embedder<S>>
...
/*!
 * \brief   Position-Independent Matrix Informed Data Embedder/Extractor
 * \author  Johann Briffa
 *
 * Matrix implementation of a position-independent block informed embedder.
 */

template <class S, class dbl>
class direct_block_informed_embedder<S, libbase::matrix, dbl>
    : public block_informed_embedder<S, libbase::matrix, dbl>
{
public:
    /*! \name Type definitions */
    typedef libbase::vector<dbl> array1d_t;
