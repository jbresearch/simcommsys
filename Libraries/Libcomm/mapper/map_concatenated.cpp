                                         ...
                                         C<array1d_t>& pout) const
{
    ...
    for (typename mapper_list_t::const_reverse_iterator mapper_it =
             mapper_list.rbegin();
         mapper_it != mapper_list.rend();
         mapper_it++) {
...
std::string map_concatenated<C, dbl>::description() const
{
    ...
    typename interface_list_t::const_iterator interface_it =
