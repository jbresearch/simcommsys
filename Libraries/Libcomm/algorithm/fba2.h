...
private:
    ...
    array1s_t r; //!< Copy of received sequence, for lazy or local computation
                 //!< of gamma
    array1vd_t app;   //!< Copy of a-priori statistics, for lazy or local
...
private:
    ...
    void fill_gamma_storage_batch(const array1s_t& r,
     ...
     * computation. It will update the cache as needed, for both local/global
     * storage.
     */
    ...
    // common small tasks
    static real get_threshold(const array2r_t& metric,
                              int row,
                              int col_min,
                              int col_max,
                              real factor,
