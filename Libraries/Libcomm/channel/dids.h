...
private:
    ...
    bool varyPi; //!< Flag to indicate that \f$ P_I \f$ should change with
                 //!< parameter
    bool varyPr; //!< Flag to indicate that \f$ P_R \f$ should change with
                 //!< parameter
    bool varyPb; //!< Flag to indicate that \f$ P_B \f$ should change with
                 //!< parameter
    ...
    double fixedPi; //!< Value to use when \f$ P_I \f$ does not change with
                    //!< parameter
    double fixedPr; //!< Value to use when \f$ P_R \f$ does not change with
                    //!< parameter
    double fixedPb; //!< Value to use when \f$ P_B \f$ does not change with
                    //!< parameter
                    // @}
private:
...
public:
    ...
    dids(const bool varyPd = true,
         const bool varyPi = true,
         const bool varyPr = false,
         const bool varyPb = false);
    // @}
