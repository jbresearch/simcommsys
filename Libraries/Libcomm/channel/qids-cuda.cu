...
__global__
void receive_kernel(const libcomm::qids::metric_computer object,
      const cuda::bitfield tx, const cuda::vector_reference<bool> rx,
      cuda::vector_reference<libcomm::qids::real> ptable)
   {
...
void qids::metric_computer::receive(const bitfield& tx, const array1b_t& rx,
