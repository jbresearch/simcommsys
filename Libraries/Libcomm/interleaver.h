...
public:
     ...
     * \param[in] in  Matrix representing the likelihoods of each possible
     * symbol for the interleaved sequence \param[out] out Matrix with
     * likelihoods of straight sequence \note 'in' and 'out' cannot be the same.
     */
