...
template <class S>
class basic_source<S, libbase::vector>
    : public basic_source_interface<S, libbase::vector>
{
public:
    libbase::vector<S>
    generate_sequence(const libbase::size_type<libbase::vector>& blocksize)
    {
        // allocate space
...
template <class S>
class basic_source<S, libbase::matrix>
    : public basic_source_interface<S, libbase::matrix>
{
public:
    libbase::vector<S>
    generate_sequence(const libbase::size_type<libbase::matrix>& blocksize)
    {
        // allocate space
